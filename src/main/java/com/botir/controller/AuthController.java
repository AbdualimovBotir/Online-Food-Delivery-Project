...
import com.botir.service.CustomerUserDetailsService;
...
import com.botir.request.LoginRequest;
import com.botir.response.AuthResponse;
...
public class AuthController {
    ...
    public ResponseEntity<AuthResponse> createuserHandler(@RequestBody User user) throws Exception {
        ...
        if(isEmailExist!=null){
            throw new Exception("Email is alredy used with another account");
        }
